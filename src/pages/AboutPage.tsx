...
export default function AboutPage() {
  return (
    <div className="bg-primary">
      <Navbar />
      <div className="pt-[72px]" style={{ isolation: 'isolate' }}>
        {/* Hero */}
        ...
        {/* Founder Section */}
        <section className="relative py-20 md:py-28 z-10" style={{ isolation: 'isolate' }}>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-5xl mx-auto">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.7 }}
                className="rounded-2xl border border-accent/20 bg-primary p-6 md:p-12 mb-10"
              >
                <div className="flex flex-col md:flex-row items-start gap-6 md:gap-8">
                  {/* Avatar */}
                  <div className="relative shrink-0">
                    <div className="w-24 h-24 md:w-32 md:h-32 rounded-2xl overflow-hidden border border-accent/20">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 md:gap-3 mt-4">
                      <a href="https://linkedin.com/in/ekharitonov" target="_blank" rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs md:text-sm font-medium text-primary-foreground/70 border border-primary-foreground/10 hover:border-accent/40 hover:text-accent transition-all bg-primary-foreground/5">
              ...
              {/* Credentials Visual Grid - outside card */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
                {credentialRows.map((section, i) => (
                  <motion.div
                    ...
                    className={`rounded-xl border ${section.borderColor} bg-primary p-5 hover:scale-[1.02] transition-transform duration-300`}
                  >
                    <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {section.items.map((item) => (
                        <div key={item.name} className="flex flex-col items-center gap-1.5 group/item">
                          ...
                          <span className="text-[10px] text-primary-foreground/40 font-medium text-center max-w-[72px] leading-tight">
                            {item.name}
                          </span>
                        </div>
                      ))}
              ...
              {/* Stats */}
              <div className="rounded-xl bg-gradient-to-r from-accent/10 via-accent/5 to-accent/10 border border-accent/20 p-6 md:p-8">
        ...
        <section className="relative py-20 md:py-28 overflow-hidden z-10" style={{ isolation: 'isolate' }}>
